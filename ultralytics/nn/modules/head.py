...
from .block import DFL, Proto ,BNContrastiveHead ,ContrastiveHead
from .conv import Conv,DWConv
from .transformer import MLP, DeformableTransformerDecoder, DeformableTransformerDecoderLayer
from .utils import bias_init_with_prob, linear_init_

__all__ = 'Detect', 'Segment', 'Pose', 'Classify', 'RTDETRDecoder', 'SAVPE','SwiGLUFFN','LRPCHead','Residual','YOLOEDetect'
...
class LRPCHead(nn.Module):
    ...
    def forward(self, cls_feat, loc_feat, conf, max_det):
        if self.enabled:
            ...
            return (loc_feat, cls_feat.flatten(2)), torch.ones(cls_feat.shape[2] * cls_feat.shape[3],
        ...
        if not has_lrpc:
            ...
            if (self.dynamic or self.shape != shape):
                self.anchors, self.strides = (x.transpose(0, 1) for x in
                                              make_anchors([b[0] for b in x], self.stride, 0.5))
                self.shape = shape
